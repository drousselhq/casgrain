...
pub(crate) const IOS_SMOKE_RUNNER_ENV: &str = "CASGRAIN_IOS_SMOKE_RUNNER";
pub(crate) const IOS_SMOKE_ARTIFACT_DIR_ENV: &str = "CASGRAIN_IOS_SMOKE_ARTIFACT_DIR";
pub(crate) const REPO_ROOT_ENV: &str = "CASGRAIN_REPO_ROOT";

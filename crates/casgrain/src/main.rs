...
mod tests {
    ...
    fn compile_command_preserves_the_first_ios_slice_plan_shape() {
        let feature = tempfile_feature(
            include_str!("../../../tests/fixtures/ios-smoke/features/tap_counter.feature"),
        ...
        assert!(json["source"]["source_name"]
            ...
            .ends_with("/tests/fixtures/ios-smoke/features/tap_counter.feature"));
...
"#,
    ...
    fn run_ios_smoke_reports_successful_tap_counter_flow() {
        ...
        assert!(output.contains("/tests/fixtures/ios-smoke/features/tap_counter.feature"));

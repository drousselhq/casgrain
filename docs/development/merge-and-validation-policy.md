...
- Casgrain's merge-gate contract is both `ios-smoke` and `android-smoke` because the product-true merge gate is the mobile simulator/emulator-backed execution contract rather than a single-platform proof.

...
- There is no separate Android-only reliability-window, reliability-qualification tracker, future-run streak requirement, or issue-sync layer for Android smoke; if the required check exposes a concrete defect, file that defect directly.

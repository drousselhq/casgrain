...
- Follow-up after this slice lands: `#129` (`Evaluate source-backed advisory automation for runner-image and host-toolchain watch`)
...
Direct source-backed advisory evaluation for selected surfaces belongs to follow-up issue #129.
...
- issue #129 becomes the backlog home for any later source-backed advisory automation on top of this baseline

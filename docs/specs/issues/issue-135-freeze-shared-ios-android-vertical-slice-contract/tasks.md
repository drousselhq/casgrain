...
- [ ] 4.6 Reconcile `docs/specs/issues/issue-79-promote-android-smoke-to-a-required-merge-gate-on-main/tasks.md` so it no longer preserves rollout-pending Android gate text or post-merge close-out steps as current truth once this slice lands on `main`.

...
- The first product-true vertical slice is intentionally minimal: one fixture-specific iOS scenario compiled from `tests/fixtures/ios-smoke/features/tap_counter.feature` and executed through `casgrain run-ios-smoke`.
